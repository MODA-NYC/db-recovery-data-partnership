...
df1 = pd.read_csv(
    "https://github.com/OpportunityInsights/EconomicTracker/blob/main/data/Zearn%20-%20County%20-%20Weekly.csv",
    dtype=str,
)
df2 = pd.read_csv(
    "https://github.com/OpportunityInsights/EconomicTracker/blob/main/data/UI%20Claims%20-%20County%20-%20Weekly.csv",
    dtype=str,
)
